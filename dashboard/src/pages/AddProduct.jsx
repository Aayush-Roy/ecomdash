...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (imageOption === 'url') {
        ...
        // For demo, we'll convert uploaded images to data URLs
  ...
  const handleImageUrlChange = (index, value) => {
    ...
    // Auto-add new empty input when last one is filled
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">Add a new product to your store</p>
      </div>
